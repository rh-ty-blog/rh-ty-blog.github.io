...
#Tuesday
On Tuesday, we started off the day by doing a stand up. We each had to state our name and talk about what we did the previous day.We followed the stand up by writing a blog about our previous day. In doing this, I learned how to use GitHub for the first time. This knowledge will benefit me going forward. After I finished my blog, we were given a talk about coding and how its done. We began using Python to practise coding. I enjoyed this task as Python is very beginner friendly and all of the interns were very eager to help. Finally, at 13:00 it was lunch time. I went for a walk around RedHat and arrived back in time for our next workshop. Our final activity of the day was a coding game called Crack A Million Passwords. This game was slightly harder than Python but i thoroughly enjoyed it all the same. Overall, i really enjoyed tuesday.
